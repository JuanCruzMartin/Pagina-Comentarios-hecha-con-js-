 ...
 let posts = []// iniciamos posteos como array vacio
 ...
 function renderPostList (){
    ...
    posts.forEach(post =>{
        ...
        <div id="editForm-${post.id}" ckass = "editForm" style="display:none">
            <laber for = "editTitle">Titulo:</label>
    ...
    fetch(`${urlBase}/${id}`,{
      ...
      .then (data =>{
        ...
        if(index != -1){
            ...
            aler ('Hubo un error al actualizar la informacion del posteo')
        }
        renderPostList()
      })
 ...
 function deletePost(id){
    ...
    .then(res=> {
        if(res.ok){
            ...
            alert (`Hubo un error y no se pudo eliminar el comentario`)
        }
    })
    .catch(error => console.error('Hubo un error no se pudo eliminar el ', error))
 }